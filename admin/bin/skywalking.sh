...
SERVICE_NAME=canal-admin

cd ..
SERVICE_HOME=`pwd`
cd bin
SW_AGENT_JAR=/xdfapp/agent/skywalking-agent.jar
...
$JAVA $JAVA_SW_AGENT $JAVA_OPTS $JAVA_DEBUG_OPT $CANAL_OPTS -classpath .:$CLASSPATH com.alibaba.otter.canal.admin.CanalAdminApplication 1>>/dev/null 2>&1 &
